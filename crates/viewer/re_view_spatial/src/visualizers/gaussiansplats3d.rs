                ...
                self.data.ui_labels.extend(process_labels_3d(
                    LabeledBatch {
                        ...
                        show_labels: data.show_labels.unwrap_or_else(|| {
                            typed_fallback_for(ctx, GaussianSplats3D::descriptor_show_labels().component)
                        }),
    ...
    fn execute(
        ...
        process_archetype::<Self, GaussianSplats3D, _>(
            ...
            |ctx, spatial_ctx, results| {
                let all_positions =
                    results.iter_required(GaussianSplats3D::descriptor_positions().component);
                ...
                let all_radii = results.iter_optional(GaussianSplats3D::descriptor_radii().component);
                ...
                let all_keypoint_ids =
                    results.iter_optional(GaussianSplats3D::descriptor_keypoint_ids().component);
                let all_show_labels =
