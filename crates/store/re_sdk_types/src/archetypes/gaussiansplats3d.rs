...
impl GaussianSplats3D {
    ...
    pub fn descriptor_half_sizes() -> ComponentDescriptor {
        ComponentDescriptor {
            ...
            component: "GaussianSplats3D:half_sizes".into(),
    ...
    pub fn descriptor_rotation_axis_angles() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.GaussianSplats3D".into()),
            component: "GaussianSplats3D:rotation_axis_angles".into(),
    ...
    pub fn descriptor_line_radii() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.GaussianSplats3D".into()),
            component: "GaussianSplats3D:line_radii".into(),
    ...
    pub fn descriptor_fill_mode() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.GaussianSplats3D".into()),
            component: "GaussianSplats3D:fill_mode".into(),
...
static REQUIRED_COMPONENTS: std::sync::LazyLock<[ComponentDescriptor; 1usize]> =
    std::sync::LazyLock::new(|| [GaussianSplats3D::descriptor_half_sizes()]);
...
static OPTIONAL_COMPONENTS: std::sync::LazyLock<[ComponentDescriptor; 7usize]> =
    std::sync::LazyLock::new(|| {
        [
            GaussianSplats3D::descriptor_rotation_axis_angles(),
            GaussianSplats3D::descriptor_quaternions(),
            GaussianSplats3D::descriptor_line_radii(),
            GaussianSplats3D::descriptor_fill_mode(),
...
static ALL_COMPONENTS: std::sync::LazyLock<[ComponentDescriptor; 10usize]> =
    std::sync::LazyLock::new(|| {
        [
            GaussianSplats3D::descriptor_half_sizes(),
            GaussianSplats3D::descriptor_centers(),
            GaussianSplats3D::descriptor_colors(),
            GaussianSplats3D::descriptor_rotation_axis_angles(),
            GaussianSplats3D::descriptor_quaternions(),
