...
impl GaussianSplats3D {
    ...
    pub fn descriptor_positions() -> ComponentDescriptor {
        ComponentDescriptor {
            ...
            component: "GaussianSplats3D:positions".into(),
    ...
    pub fn descriptor_radii() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.GaussianSplats3D".into()),
            component: "GaussianSplats3D:radii".into(),
    ...
    pub fn descriptor_labels() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.GaussianSplats3D".into()),
            component: "GaussianSplats3D:labels".into(),
    ...
    pub fn descriptor_show_labels() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.GaussianSplats3D".into()),
            component: "GaussianSplats3D:show_labels".into(),
    ...
    pub fn descriptor_class_ids() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.GaussianSplats3D".into()),
            component: "GaussianSplats3D:class_ids".into(),
    ...
    pub fn descriptor_keypoint_ids() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.GaussianSplats3D".into()),
            component: "GaussianSplats3D:keypoint_ids".into(),
...
static REQUIRED_COMPONENTS: std::sync::LazyLock<[ComponentDescriptor; 1usize]> =
    std::sync::LazyLock::new(|| [GaussianSplats3D::descriptor_positions()]);

static RECOMMENDED_COMPONENTS: std::sync::LazyLock<[ComponentDescriptor; 2usize]> =
    std::sync::LazyLock::new(|| [GaussianSplats3D::descriptor_radii(), GaussianSplats3D::descriptor_colors()]);

static OPTIONAL_COMPONENTS: std::sync::LazyLock<[ComponentDescriptor; 4usize]> =
    std::sync::LazyLock::new(|| {
        [
            GaussianSplats3D::descriptor_labels(),
            GaussianSplats3D::descriptor_show_labels(),
            GaussianSplats3D::descriptor_class_ids(),
            GaussianSplats3D::descriptor_keypoint_ids(),
        ]
    });
...
static ALL_COMPONENTS: std::sync::LazyLock<[ComponentDescriptor; 7usize]> =
    std::sync::LazyLock::new(|| {
        [
            GaussianSplats3D::descriptor_positions(),
            GaussianSplats3D::descriptor_radii(),
