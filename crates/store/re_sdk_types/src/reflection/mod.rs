...
fn generate_archetype_reflection() -> ArchetypeReflectionMap {
    ...
    let array = [
        ...
        (
            ArchetypeName::new("rerun.archetypes.GaussianSplats3D"),
            ArchetypeReflection {
                display_name: "GaussianSplats 3D",
                deprecation_summary: None,
                scope: None,
                view_types: &["Spatial3DView", "Spatial2DView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Half sizes",
                        component_type: "rerun.components.HalfSize3D".into(),
                        docstring_md: "For each gaussiansplats, half of its size on its three axes.\n\nIf all components are equal, then it is a sphere with that radius.",
                        is_required: true,
                    },
                    ArchetypeFieldReflection {
                        name: "centers",
                        display_name: "Centers",
                        component_type: "rerun.components.Translation3D".into(),
                        docstring_md: "Optional center positions of the gaussiansplats.\n\nIf not specified, the centers will be at (0, 0, 0).",
                        is_required: false,
                    },
                    ArchetypeFieldReflection {
                        name: "rotation_axis_angles",
                        display_name: "Rotation axis angles",
                        component_type: "rerun.components.RotationAxisAngle".into(),
                        docstring_md: "Rotations via axis + angle.\n\nIf no rotation is specified, the axes of the gaussiansplats align with the axes of the local coordinate system.",
                        is_required: false,
                    },
                    ArchetypeFieldReflection {
                        name: "quaternions",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Colors",
                        component_type: "rerun.components.Color".into(),
                        docstring_md: "Optional colors for the gaussiansplats.\n\nAlpha channel is used for transparency for solid fill-mode.",
                        is_required: false,
                    },
                    ArchetypeFieldReflection {
                        name: "line_radii",
                        display_name: "Line radii",
                        component_type: "rerun.components.Radius".into(),
                        docstring_md: "Optional radii for the lines used when the gaussiansplats is rendered as a wireframe.",
                        is_required: false,
                    },
                    ArchetypeFieldReflection {
                        name: "fill_mode",
                        display_name: "Fill mode",
                        component_type: "rerun.components.FillMode".into(),
                        docstring_md: "Optionally choose whether the gaussiansplats are drawn with lines or solid.",
                        is_required: false,
                    },
                    ArchetypeFieldReflection {
                        name: "labels",
                        display_name: "Labels",
                        component_type: "rerun.components.Text".into(),
                        docstring_md: "Optional text labels for the gaussiansplats.",
                        is_required: false,
                    },
                    ArchetypeFieldReflection {
                        name: "show_labels",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Class ids",
                        component_type: "rerun.components.ClassId".into(),
                        docstring_md: "Optional class ID for the gaussiansplats.\n\nThe class ID provides colors and labels if not specified explicitly.",
                        is_required: false,
                    },
                ],
            },
