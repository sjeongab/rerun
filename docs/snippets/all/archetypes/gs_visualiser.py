...
# 1. Get the absolute path to ensure no errors
current_dir = os.path.dirname(os.path.abspath(__file__))
lib_path = os.path.join(current_dir, LOCAL_LIB_FOLDER)


# 2. Insert at position 0 so it takes priority over pip-installed versions
